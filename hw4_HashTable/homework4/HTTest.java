...
public class HTTest {
    ...
    public static void main(String[] args) throws IOException {
        ...
        theHashTable.insert("a");
        theHashTable.remove("a");
        theHashTable.insert("b");
        theHashTable.remove("b");
        theHashTable.insert("c");
        theHashTable.remove("c");
        theHashTable.insert("d");
        theHashTable.remove("d");
        theHashTable.insert("e");
        theHashTable.remove("e");
        theHashTable.insert("f");
        theHashTable.remove("f");
        theHashTable.insert("g");
        theHashTable.remove("g");
        theHashTable.insert("h");
        theHashTable.remove("h");
        theHashTable.insert("i");
        theHashTable.remove("i");
        theHashTable.insert("j");
        theHashTable.remove("j");
        theHashTable.insert("k");
        theHashTable.remove("k");
//        theHashTable.insert("l");
